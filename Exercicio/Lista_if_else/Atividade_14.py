...
try:
    _quilos_racao = float(input('Quantos quilogramas de ração você comprou? ')) * 1000
    if _quilos_racao <= 0:
...
if total < 0:
    print(f'Durante a semana faltará {total/ 1000}Kg de ração.')
else:
    print(f'Após uma semana restará apenas {total / 1000}Kg de ração.')
